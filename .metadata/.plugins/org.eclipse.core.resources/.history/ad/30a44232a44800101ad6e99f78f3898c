...
<html lang="pt-br">
	<head>
		...
		<title>CRUD Manager - Posts</title>
	</head>
	<body>
		...
		<div id="container" class="container-fluid">
			<div id="alert" style="${not empty message ? 'display: block;' : 'display: none;'}" class="alert alert-dismissable ${alertType eq 1 ? 'alert-success' : 'alert-danger'}">
	 	 	...
	 	 	<div id="top" class="row">
			    ...
			    <div class="col-md-3">
			        <a href="${pageContext.request.contextPath}/post/form" class="btn btn-danger pull-right h2"><span class="glyphicon glyphicon-plus" /></span>&nbspAdicionar Post</a>
			    </div>
	     	</div>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery.min.js"></script> <%-- Ajustado contextPath --%>
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/bootstrap.min.js"></script> <%-- Ajustado contextPath --%>
		<script type="text/javascript">
			$(document).ready(function() {
			    ...
			    $(".modal-remove").click(function () {
		            ...
		            $("#form").attr( "action","${pageContext.request.contextPath}/post/delete"); 
		        })
			});
		</script>
	</body>
