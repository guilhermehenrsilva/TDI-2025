	...
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="${pageContext.request.contextPath}">
		    	<span><img height="30px" width="30px" alt="LJ" src="${pageContext.request.contextPath}/images/logo.png"><strong>&nbsp🎮 Locadora de Jogos</strong></strong></span>
		    </a>
		</div>
		<div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="${pageContext.request.contextPath}/post"><span class="glyphicon glyphicon-pencil" /><strong>&nbspPosts</strong></a></li> <%-- CORRIGIDO AQUI: de /post para /posts --%>
